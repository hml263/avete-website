  ...
  return (
    <div className='relative items-center justify-center'>
            ...
            >
              ...
              >
              <Image
              src='/Earth-At-Night-Globe.svg' height={350} width={350} alt='globe'
              ...
              <motion.div
               ...
               >
                ...
                className='lg:h-[307px] w-[380px] h-[280px]'
                viewBox="0 0 537 537" fill="none" xmlns="http://www.w3.org/2000/svg">
                {/* <path
    ...
    <path
        ...
        fill="#00B9E4" />
    <circle cx="267.683" cy="268.113" r="183" transform="rotate(-39.3234 267.683 268.113)" stroke="#00B9E4"
        strokeOpacity="0.7" stroke-width="2" />
    <circle cx="268" cy="268" r="254" stroke="#00B9E4" strokeOpacity="0.9" stroke-width="2" />
    <path
